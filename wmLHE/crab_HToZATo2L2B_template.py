...
config.General.workArea = 'wmLHE_prod-v0'
...
config.Data.totalUnits = 150000 # 150k, overproducing to account for failed jobs, just in case
config.Data.splitting = 'EventBased'
config.Data.outputPrimaryDataset = 'HToZATo2L2B_template'
config.Data.outputDatasetTag = 'wmLHE_prod-v0'
